...
import { FileText, Eye, CheckCircle, XCircle, Upload, Save, User } from 'lucide-react';
...
export function CandidateDashboard() {
  ...
  // Mocking candidaturas ativas
  const [appliedJobs, setAppliedJobs] = useState([
    jobsMock[0],
    jobsMock[2]
  ]);

  // Estados para edição de perfil completo
  ...
  return (
    <S.DashboardContainer>
      ...
      <section style={{ margin: '2rem 0', background: 'white', padding: '1.5rem', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
     ...
     <SponsorCarousel />
      ...
      <section style={{ margin: '2rem 0' }}>
        ...
        {appliedJobs.length > 0 ? (
          ...
          <p style={{ color: '#64748b' }}>Você não tem nenhuma candidatura ativa no momento.</p>
        )}
      </section>
